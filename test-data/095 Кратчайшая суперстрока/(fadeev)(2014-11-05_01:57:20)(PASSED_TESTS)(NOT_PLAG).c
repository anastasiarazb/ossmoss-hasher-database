// очень печально, что стоит ограничение по памяти
// посмотрите тот вариант, который превышает память
//этот вариант пришлось гуглить. В итоге нашел статью на хабре.
